...
<div class="width1198 center_yh" style="height: 420px;">
    ...
    <div class="left_yh" style="width: 350px;height: 420px;">
        ...
        <div id="preview">
            <div>
                <img src="${pageContext.request.contextPath}/DisplayImage?src=${goodsDetail.goodsImg}" alt=""
    ...
    <div class="left_yh" style="width: 486px;height: 420px;margin-left: 42px;">
        <h3 class="font20 font100">${goodsDetail.goodsName}</h3>
        ...
        <p class="font16 c_66 likeColor" style="margin-top: 25px;">
            ...
            <font class="font14 c_99" style="margin-left: 20px;">库存${goodsDetail.stock}</font>
            <p class="font14 c_99" style="margin-left: 15px;: ">销量${goodsDetail.sell}</p>
        </p>
        <div class="buyFor">
        ...
        $(".addCar").click(function () {
            ...
            if (${(empty iusers.id)}) {
                ...
                $.ajax({
                    ...
                    url: "${ctx}/rest/cart",
                    data: JSON.stringify({"goodsId": id, "userId": userId, "number": num}),
                    dataType: 'json',
                    success: function (result) {
                        ...
                        <%--}else {--%>
                        <%--    window.location.href="${ctx}/cart/car";--%>
                        <%--}--%>
                    }
                });
            }

            <%--}else if (${(empty iusers.id)}){--%>
            <%--    --%>
            <%--}--%>
        });
    });
