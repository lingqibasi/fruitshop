...
<div class="width1200 center_yh hidden_yh font14" style="height: 40px;line-height: 40px;">
    <span>当前位置：</span><a href="${ctx}/front/uIndex" class="c_66">首页</a>
...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            <a href="${ctx}/front/my" class="on">个人信息</a>
            <a href="${ctx}/front/itemOrders">我的订单</a>
                ...
                <div class="hidden_yh bj_fff" style="width: 938px;border: 1px solid #ddd;">
                    ...
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 25px;">
                        <div class="left_yh font16 tright" style="width: 120px;">
                            ...
                            <input type="text" name="realName" value="${obj.name}" style="width: 243px;border: 1px solid #ddd;outline: none;height:30px;text-indent: 10px;">
                    </div>
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 25px;">
                        <div class="left_yh font16 tright" style="width: 120px;">
...
<%--                    </div>--%>
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 25px;">
                        ...
                        <input type="text" name="address" value="" style="width: 243px;border: 1px solid #ddd;outline: none;height:30px;text-indent: 10px;">
                    </div>
